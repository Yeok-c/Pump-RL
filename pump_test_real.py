...
for load in test_loads:
    ...
    #     # K_deform = 0.01,
    #     )
    env = PumpRealEnvVar_Two()  # real pump
    ...
    for ep in range(episodes):
        ...
        VL, VR = env.pump.V_L/env.pump.Lchamber_V, env.pump.V_R/env.pump.Rchamber_V  # real pump TODO: Chamber_V
        ...
        while not done:
            ...
            # R.append(reward)
            P_R.append((env.pump.pressure[3]-P_0)/1000)  # real pump
            P_R_G.append((env.goal_pressure_R-P_0)/1000)
