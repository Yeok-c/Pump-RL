...
class chamber:
    def __init__(self, L0, P0, load_volume=0, K_deform=0.05):
        ...
        self.a = 0.034 #34mm, old: 0.03  # The short edge of chamber cross surface
        self.c = 0.0068 # 6.8mm, old: 0.03  # The long edge of chamber cross surface
        self.n = 6   # The number of element size
        self.h = 0.004 # 4mm,  h = L / self.n / 2
        self.L = 2*self.n*self.h # self.L = L0  # Length of chamber
...
if __name__ == '__main__':
    ...
    pump.render(title='step 1', time=1, render_chamber_pressures=True)

    pump.move_motor_to_R(0.025)
    print('start:', 'self.pump.Lchamber.P:', pump.Lchamber.P, 'self.pump.Rchamber.P:', pump.Rchamber.P)
    pump.render(title='step 1', time=2, render_chamber_pressures=True)

    pump.move_motor_to_L(0.05)
    print('start:', 'self.pump.Lchamber.P:', pump.Lchamber.P, 'self.pump.Rchamber.P:', pump.Rchamber.P)
    pump.render(title='step 1', time=3, render_chamber_pressures=True)
