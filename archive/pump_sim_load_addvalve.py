...
class chamber:
    def __init__(self, L0, P0, load_volume=0):
...
class hybrid_pump:
    def __init__(self, L_L, L_R, load_chamber_ratio_L, load_chamber_ratio_R):
        self.P_M = 0  # motor
        ...
        self.Lchamber = chamber(L_L, P_0, load_volume=load_chamber_ratio_L*V_0)
        self.Rchamber = chamber(L_R, P_0, load_volume=load_chamber_ratio_R*V_0)
