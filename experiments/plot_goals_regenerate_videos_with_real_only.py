...
'''
os.chdir("./Pump-RL-Real/experiments/controllers/non-deformable")
cyan = '#8ECFC9'
orange = '#FFBE7A'
...
filepaths = glob.glob("./saved_figures_*/*/" + "*.p")
print(filepaths)
...
for pickle_file in filepaths:
    ...
    os.system(f"ffmpeg -r 3 -i {png_file_query} -vcodec libx264 -y {mp4_file_path}")
