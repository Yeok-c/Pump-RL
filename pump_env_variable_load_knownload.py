...
class PumpEnvVar(PumpEnv):
    ...
    def normalization(self, observation):
        ...
        observation_range_low = np.array([goal_pressure_min, 0.0, 0.01*P_0, 0.01*P_0, 0.049, 0.049, -0.05, 0.0, 0.0, 0.0, self.load_range[0]])
        observation_range_high = np.array([goal_pressure_max, 1.0, 10*P_0, 10*P_0, 0.151, 0.151, +0.05, 1.0, 1.0, 1.0, self.load_range[1]])
